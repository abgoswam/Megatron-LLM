...
python weights_conversion/megatron_to_hf.py \
    --input_dir  /mnt/synthdatastore/agoswami/models_04_postlaborday/my_starcoder_trials_0920/ckpts/out_phi3_orig1_reshard10000_redpajama/ \
	--output_dir /mnt/synthdatastore/agoswami/models_04_postlaborday/my_starcoder_trials_0920/ckpts/out_phi3_orig1_reshard10000_redpajama_hf/ \
    --model phi3 \
