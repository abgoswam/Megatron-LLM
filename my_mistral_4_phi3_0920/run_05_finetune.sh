...
torchrun $DISTRIBUTED_ARGS finetune.py \
	...
	--save /mnt/synthdatastore/agoswami/models_04_postlaborday/my_phi35_pretrain_trials_0920/ckpts/out_combo2_tp${TP}_save_redpajama \
	--tensorboard_dir /mnt/synthdatastore/agoswami/models_04_postlaborday/my_phi35_pretrain_trials_0920/ckpts/out_combo2_tp${TP}_save_redpajama/tensorboard/ \
	--data_path /mnt/synthdatastore/agoswami/models_04_postlaborday/my_phi35_pretrain_trials_0920/data_verify_correctness_combo2/my_redpajama1_using_combo2_text_document \
