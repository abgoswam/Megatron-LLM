...
torchrun $DISTRIBUTED_ARGS finetune.py \
	...
	--save /mnt/synthdatastore/agoswami/models_04_postlaborday/out_mistral_7b_tp${TP}_red_pajama \
	--tensorboard_dir /mnt/synthdatastore/agoswami/models_04_postlaborday/out_mistral_7b_tp${TP}_red_pajama/tensorboard/ \
	--data_path ./my_repro_0908/my_red_pajama_10k_mistral/my_red_pajama_10k_mistral_text_document \
	--model_name mistral \
